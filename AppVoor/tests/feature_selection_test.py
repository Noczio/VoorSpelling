...
from feature_selection import SFMFeatureSelection, RFEFeatureSelection
...
class MyTestCase(unittest.TestCase):
    ...
    def test_molecules_has_fewer_features(self):
    ...
    def test_diabetes_has_fewer_features(self):
        # load molecules.csv from disk
        folder_name = "datasets"
